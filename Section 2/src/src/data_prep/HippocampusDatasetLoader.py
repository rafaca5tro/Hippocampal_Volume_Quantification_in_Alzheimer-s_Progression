...
def LoadHippocampusData(root_dir, y_shape, z_shape):
    ...
    for f in images:
        ...
        # ANSWER: Scikit or other libraries learn only handles real numbers. So you need 
        #to do something like one hot encoding where n numerical dimensions are 
        #used to represent membership in the categories. If you just pass in 
        #strings they'll get cast to floats in unpredictable ways.
